    ...
    <section className="relative bg-[var(--bg-main)] pt-20 pb-16 lg:pt-36 lg:pb-32 border-b-2 border-[var(--border-color)] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8 z-10">
          <div className="inline-flex items-center gap-2 bg-yellow-500/10 text-yellow-600 px-4 py-1.5 rounded-full text-sm font-bold border border-yellow-500/20 shadow-sm backdrop-blur-sm animate-fade-in">
          ...
          <h1 className="text-5xl lg:text-6xl font-extrabold text-[var(--text-main)] leading-[1.15] tracking-tight">
            Villamos biztonsági felülvizsgálat.<br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-500">Gyorsabban, pontosabban.</span>
          </h1>
        ...
        <div className="relative mx-auto w-full max-w-lg lg:max-w-none z-10 group perspective-1000">
          <div className="absolute inset-0 bg-gradient-to-tr from-primary/30 to-blue-500/30 blur-[80px] rounded-full group-hover:scale-110 transition-transform duration-700"></div>
          
          <div className="relative bg-[var(--bg-card)]/80 backdrop-blur-xl border border-[var(--border-color)] p-8 sm:p-10 rounded-3xl shadow-2xl flex flex-col gap-8 overflow-hidden transform transition-all duration-500 hover:rotate-1 hover:scale-[1.02]">
            ...
            <div className="relative h-28 sm:h-36 w-full rounded-xl bg-[var(--bg-input)] border border-[var(--border-color)] p-5 flex items-center justify-between overflow-hidden shadow-inner">
              ...
              <div className="relative z-10 w-14 sm:w-20 h-20 sm:h-24 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-lg shadow-lg flex flex-col items-center justify-center transform transition-transform hover:-translate-y-1 delay-75">
                <div className="w-full h-3 border-b border-[var(--border-color)] absolute top-0 rounded-t-lg"></div>
                <div className="w-2 h-6 bg-primary rounded-full shadow-[0_0_10px_rgba(var(--color-primary),0.5)]"></div>
              </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                <span className="bg-green-500/10 text-green-400 px-3 py-1.5 rounded-md text-xs font-bold border border-green-500/20 shadow-sm backdrop-blur">Saját logó</span>
                <span className="bg-blue-500/10 text-blue-400 px-3 py-1.5 rounded-md text-xs font-bold border border-blue-500/20 shadow-sm backdrop-blur">Szakértői motor</span>
